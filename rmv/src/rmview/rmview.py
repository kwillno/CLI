...
class rMViewApp(QApplication):
    ...
    def detectOrientation(self, image):
        ...
        if (
            c(48, 47) == 4278190080
            and c(72, 72) == 4278190080
            and (c(55, 55) == 4294967295 or c(64, 65) == 4294967295)
        ):
            if c(61, 1812) != 4278190080 or c(5, 5) == 4278190080:
                portrait = True
        elif (
            c(1356, 47) == 4278190080
            and c(1329, 72) == 4278190080
            and (c(1348, 54) == 4294967295 or c(1336, 65) == 4294967295)
        ):
            portrait = True
    ...
    def ensureConnConfig(self):
        ...
        if (
            self.config["ssh"].get("password") is None
            and self.config["ssh"].get("key") is None
        ):
    ...
    def connected(self, ssh):
        ...
        self.fbworker = FrameBufferWorker(
            ssh, delay=self.config.get("fetch_frame_delay")
        )
